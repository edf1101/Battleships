...
class BattleshipsGame:
   ...
   """
    ...
    def attack(self) -> dict:
        ...
        self.players['AI']['guess_board'] = game_engine.shift(self.players['AI']['guess_board'],
                                                              self.storm_direction)
        self.players['Human']['board'] = game_engine.shift(self.players['Human']['board'],
                                                           self.storm_direction)
        shifted_board = game_engine.shift(self.players['Human']['guess_board'],
                                          self.storm_direction)
        self.players['Human']['guess_board'] = shifted_board
        self.players['AI']['board'] = game_engine.shift(self.players['AI']['board'],
                                                        self.storm_direction)
